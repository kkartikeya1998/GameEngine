...
using GameEvent = std::variant<
    PlayerJumped, InventoryOpened, GamePaused, GameResumed,
    InteractionRequested, DialogueFinished, BattleFinished,
    ItemConsumed, ItemPickedUp
>;

using GameEventQueue = EventQueue<GameEvent>;